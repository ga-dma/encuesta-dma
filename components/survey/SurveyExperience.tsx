...
export default function SurveyExperience() {
  ...
  const send = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const response = await updateQuizResultEmail(categories[category].name[language], score, email);
